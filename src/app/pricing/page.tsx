                        ...
                        {pricingItems.map(
                            ({ plan, tagline, quota, features }) => {
                                ...
                                return (
                                    ...
                                    >
                                        {plan === 'Pro' && (
                                            <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-primary-600 to-cyan-600 px-3 py-2 text-sm font-medium text-primary">
                                                Upgrade now
                                            </div>
                                        )}
                                        ...
                                        <div className="flex h-20 items-center justify-center border-b border-t border-secondary-200 bg-secondary-50">
                                            <div className="flex items-center space-x-1">
                                                ...
                                                <Tooltip delayDuration={300}>
                                                    ...
                                                    <TooltipContent className="w-80 p-2 bg-primary-50">
